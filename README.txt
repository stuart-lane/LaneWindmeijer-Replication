...
POZZI (2022) DATASET:
(Optional) Run construct_cleaned_data.py to construct the cleaned dataset
from the raw dataset:

   CLEAN_RAW_POZZI_DATA = False

by default. This is optional, as the cleaned dataset is included in the replication 
package convenience.
